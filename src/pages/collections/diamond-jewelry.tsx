...
import { Search, Filter, Grid, List, Heart, Eye, X, ChevronDown, ChevronUp, SlidersHorizontal, Gem } from 'lucide-react';
...
// Mock data for diamond jewelry items
...
const categories = ['Earrings', 'Necklace', 'Ring', 'Pendant', 'Set'];
...
const DiamondJewelryPage = () => {
  ...
  const popularSearches = ['Diamond Earrings', 'Diamond Ring', 'Diamond Necklace', 'Solitaire'];

  useEffect(() => {
    if (searchTerm.length > 0) {
      const suggestions = diamondJewelry
        .filter(item => 
  ...
  const filteredJewelry = useMemo(() => {
    let filtered = diamondJewelry.filter(item => {
  ...
  return (
    <>
      <SEO
        title="Diamond Jewelry Collection - Heritage Jewels"
        description="Explore our stunning collection of diamond jewelry including solitaires, diamond sets, pendants, and engagement rings. Certified diamonds with exceptional brilliance."
        keywords="diamond jewelry, diamond rings, diamond earrings, diamond necklace, solitaire rings, diamond sets, engagement rings"
        canonical="/collections/diamond-jewelry"
      />
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="text-center">
              <div className="flex items-center justify-center mb-4">
                <Gem className="h-12 w-12 text-blue-500 mr-4" />
                <h1 className="font-playfair text-4xl font-bold text-burgundy">
                  Diamond Jewelry Collection
                </h1>
              </div>
              <p className="text-charcoal/70 max-w-2xl mx-auto">
                Discover our exquisite collection of diamond jewelry, featuring certified diamonds 
                that capture light and hearts with their exceptional brilliance and fire.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex-1">
              ...
              <div className="bg-white rounded-lg p-4 mb-6 shadow-sm">
                <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                  ...
                  <div className="relative flex-1 max-w-md">
                    <div className="relative">
                      ...
                      <Input
                        placeholder="Search diamond jewelry..."
                        value={searchTerm}
                ...
                <div className="mt-4 text-sm text-charcoal/70">
                  Showing {filteredJewelry.length} diamond jewelry items
                </div>
                ...
                {filteredJewelry.length > 0 ? (
                  ...
                  >
                    <div className="max-w-md mx-auto">
                      <Gem className="h-16 w-16 text-blue-500 mx-auto mb-4" />
                      <h3 className="font-playfair text-xl font-semibold text-charcoal mb-4">
                        No diamond jewelry found
                      </h3>
                      <p className="text-charcoal/70 mb-6">
                        Try adjusting your filters or search terms to find the perfect diamond piece.
                      </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-blue-500">Diamond</p>
                      </div>
                      <div>
